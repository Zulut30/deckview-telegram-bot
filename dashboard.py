...
def admin_pub_hsguru():
    ...
    try:
        from hsguru_meta import get_meta
...
def admin_pub_comps():
    ...
    try:
        from bgs_comps import get_bgs_comps, PERIOD_LABEL as COMPS_PERIOD_LABEL, ARCHETYPE_TRIBE, MIN_GAMES
...
def admin_api_archetypes_import():
    ...
    init_db()
    try:
        from hsguru_fetch import load_archetypes as _fetch_archetypes
        # Force loading from Google Sheet (bypass DB)
        from config import ARCHETYPES_SHEET_URL
