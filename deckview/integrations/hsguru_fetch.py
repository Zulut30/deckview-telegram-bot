...
try:
    from deckview.integrations.hs_data_api import HSDataAPIError, get_streamer_decks as get_data_api_streamer_decks
except Exception:
...
def load_archetypes() -> Dict[str, str]:
    ...
    """
    try:
        from deckview.repositories.web import get_all_archetypes as _db_archetypes
        rows = _db_archetypes()
        if rows:
